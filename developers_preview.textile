...
* Only a few bugs (please report them)
* Support for Live MP3 Streams
* Consistent default theming (thanks umbighouse)
* Selectable theme support
* High contrast theme (thanks Tyler)
...
* Start the server
* Visit "http://localhost:8001":http://localhost:8001 to configure your live mp3 streams
...
We're about ready to bless this one as the next release. Please report any and all bugs and surprises that you encounter while using this software.
